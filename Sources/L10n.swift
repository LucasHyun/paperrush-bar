...
enum L10n {
    ...
    private static let table: [String: [String: String]] = [
        ...
        "app.noStarred": ["en": "Nothing coming up among your stars",
                          "ko": "별표한 학회의 다가오는 마감이 없습니다",
                          "zh": "收藏的会议暂无即将到来的截止"],
        ...
        "settings.scan.title": ["en": "Check against the conference pages",
                                "ko": "학회 페이지와 대조하기",
                                "zh": "与会议官网核对"],
        "settings.scan.blurb": ["en": "Reads each conference's own site and reports dates that differ from the data. A date is only proposed when it is literally on the page it cites — nothing is changed until you apply it. On the free tier a full scan takes about three minutes.",
                                "ko": "각 학회 사이트를 읽어 데이터와 다른 날짜를 찾아냅니다. 인용한 페이지에 실제로 적혀 있는 날짜만 제안하며, 적용하기 전까지는 아무것도 바뀌지 않습니다. 무료 등급에서는 전체 검사에 3분 정도 걸립니다.",
                                "zh": "读取各会议官网，列出与数据不一致的日期。只有在所引用页面上确实出现的日期才会被提议，未经你确认不会改动任何数据。免费额度下完整核对约需三分钟。"],
        ...
        "settings.scan.incomplete": ["en": "Stopped after %@ conferences — see below.",
                                     "ko": "학회 %@곳까지 확인하고 멈췄습니다 — 아래를 확인하세요.",
                                     "zh": "核对 %@ 个会议后停止 —— 见下方说明。"],
        "settings.scan.unreadable": ["en": "%@ had no readable page",
                                     "ko": "페이지를 읽지 못한 학회 %@곳",
                                     "zh": "%@ 个会议的页面无法读取"],
        ...
        "scout.error.keychain": ["en": "Could not read the key from the keychain. Allow access when macOS asks, or enter the key again.",
                                 "ko": "키체인에서 키를 읽지 못했습니다. macOS가 물으면 허용하거나, 키를 다시 입력해 주세요.",
                                 "zh": "无法从钥匙串读取密钥。请在 macOS 询问时允许访问，或重新输入密钥。"],
        "scout.error.noModel": ["en": "None of the Gemini models this app knows is available to your key. Please open an issue on GitHub.",
                                "ko": "이 키로 쓸 수 있는 Gemini 모델을 찾지 못했습니다. GitHub에 이슈로 알려 주세요.",
                                "zh": "你的密钥无法使用本应用已知的任何 Gemini 模型。请在 GitHub 上提交 issue。"],
